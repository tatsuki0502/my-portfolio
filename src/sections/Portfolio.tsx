...
const projectList = [
  {
    ...
    image: todo,
    description:
      "シンプルで使いやすいタスク管理アプリ。React + TypeScript + Vite で構築。",
    links: {
...

  {
    ...
    image: weather,
    description:
      "React + TypeScript + OpenWeatherMap API を用いた天気予報アプリ。",
    links: {
...

  {
    ...
    image: chat,
    description:
      "React + Firebase を使ったリアルタイムチャットアプリ。Googleログイン対応。",
    links: {
  ...
  return (
    <Box id="projects" sx={{ py: 8, px: 2, textAlign: "center" }}>
      ...
      <Typography variant="body1" sx={{ mt: 1 }}>
        React ×
        TypeScriptを中心に、API連携や状態管理、UIライブラリの活用まで幅広く対応可能です。
      </Typography>
